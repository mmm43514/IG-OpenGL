...
Escena::Escena()
{
   ...
   // ...
	col_fuentes = new Col2Fuentes(); // fuente arbitraria
	material_ini = new Material(); // material arbitrario
...
void Escena::visualizarGL( ContextoVis & cv )
{
   ...
   if ( cv.iluminacion )
   {
      ...
      // ....
		...
		assert(col_fuentes != NULL && material_ini != NULL);
...
Escena2::Escena2()
{
   ...
   objetos.push_back( new Cilindro(12, 24, true) );
   objetos.push_back( new Cono(12, 24) );
   objetos.push_back( new Esfera(12, 24) );
   objetos.push_back( new MallaRevolPLY("./plys/TamborArco.ply", 20) );
   objetos.push_back( new MallaPLY("../recursos/plys/beethoven.ply") );
   objetos.push_back( new Toro(24,48) );
   objetos.push_back( new ArcoRect(48) );
   objetos.push_back( new EngancheArco() );
...
Escena3::Escena3()
{
  ...
  objetos.push_back( new C(0,0,0.5,0.5,77) ) ;
